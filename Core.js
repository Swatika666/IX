...
const cpu = os.cpus()[0];
const totalCpuUsage = (
  (100 * (cpu.times.user + cpu.times.nice + cpu.times.sys + cpu.times.irq)) /
  cpu.times.idle
).toFixed(2);
...
//
module.exports = IX = async (IX, m, chatUpdate, store) => {
  try {
    var body =
    ...
    const botNumber = await IX.decodeJid(IX.user.id);
    ...
    const groupMetadata = m.isGroup
      ? await IX.groupMetadata(m.chat).catch((e) => {})
      : "";
    ...
    autoreadsw = true;
    _sewa.expiredCheck(IX, sewa);

    const reply = (teks) => {
      IX.sendMessage(m.chat, { text: teks }, { quoted: m });
    };
    ...
    //   if (command) {
    //     await IX.sendPresenceUpdate("composing", m.chat);
    //     IX.sendReadReceipt(from, m.sender, [m.key.id]);
    //   }
    // }
    ...
    //   if (m.isGroup) {
    //       IX.sendReadReceipt(m.chat, m.sender, [m.key.id]);
    //   }
    // }
    ...
    if (global.autoreadgc) {
      if (command) {
        ...
        await IX.readMessages(keysToMarkAsRead);
      }
    }

    if (global.autoRecord) {
      if (m.chat) {
        IX.sendPresenceUpdate("recording", m.chat);
      }
    }

    if (global.autoTyping) {
      if (m.chat) {
        IX.sendPresenceUpdate("composing", m.chat);
      }
    }

    if (global.available) {
      if (m.chat) {
        IX.sendPresenceUpdate("available", m.chat);
      }
    }
    ...
    function updateStatus() {
      ...
      // const status = `
      // ㅤㅤ〄ㅤㅤ〘 IX Personal Edition 〙ㅤㅤ〄ㅤㅤㅤㅤ
      // ㅤㅤㅤ〘ㅤ Auto Uptime: ${uptimeFormatted}ㅤ〙`;

      function _0x582b(_0xabb6f8, _0x12cdd8) {
        const _0x58e890 = _0x58e8();
        return (
          (_0x582b = function (_0x582b90, _0x4387b3) {
            _0x582b90 = _0x582b90 - 0x189;
            let _0x932613 = _0x58e890[_0x582b90];
            return _0x932613;
          }),
          _0x582b(_0xabb6f8, _0x12cdd8)
        );
      }
      function _0x58e8() {
        const _0x109554 = [
      ...
      (function (_0x429d7b, _0x532ab5) {
        const _0x527567 = _0x582b,
          _0x130eb4 = _0x429d7b();
        while (!![]) {
          try {
            const _0x75c57a =
              -parseInt(_0x527567(0x18b)) / 0x1 +
              (-parseInt(_0x527567(0x192)) / 0x2) *
                (-parseInt(_0x527567(0x189)) / 0x3) +
              (parseInt(_0x527567(0x191)) / 0x4) *
                (-parseInt(_0x527567(0x190)) / 0x5) +
              -parseInt(_0x527567(0x18f)) / 0x6 +
              parseInt(_0x527567(0x18d)) / 0x7 +
              (parseInt(_0x527567(0x18e)) / 0x8) *
                (-parseInt(_0x527567(0x18a)) / 0x9) +
              (parseInt(_0x527567(0x193)) / 0xa) *
                (parseInt(_0x527567(0x18c)) / 0xb);
            if (_0x75c57a === _0x532ab5) break;
            else _0x130eb4["push"](_0x130eb4["shift"]());
          } catch (_0x19ea04) {
            _0x130eb4["push"](_0x130eb4["shift"]());
          }
        }
      })(_0x58e8, 0xa8dae);
      const status =
        "\x0a\x20\x20ㅤㅤ〄ㅤㅤ〘\x20IX\x20Personal\x20Edition\x20〙ㅤㅤ〄ㅤㅤㅤㅤ\x0a\x20\x20ㅤㅤㅤ〘ㅤ\x20Auto\x20Uptime:\x20" +
        uptimeFormatted +
        "ㅤ〙";

      IX.setStatus(status); // Set the status using IX.setStatus or your equivalent method
...
Typed *surrender* to surrender and admited defeat`;
      ...
      if (room.x !== room.o)
        await IX.sendText(room.x, str, m, { mentions: parseMention(str) });
      await IX.sendText(room.o, str, m, { mentions: parseMention(str) });
      if (isTie || isWin) {
  ...
  */
    ...
    try {
      if (m.mtype === "interactiveResponseMessage") {
        ...
        if (msg.nativeFlowResponseMessage && !m.isBot) {
          ...
          if (id) {
            ...
            return IX.ev.emit("messages.upsert", {
              messages: [emit_msg],
              type: "append",
            });
          }
      ...
      console.log("ERROR WHILE CHECKING LIST RESPONCE : ", e);
    }
    ...
    switch (command) {
      ...
      case "sourcecode":
        {
          ...
          IX.sendMessage(from, { react: { text: "❤", key: m.key } });

          let { data } = await axios.get(
            "https://api.github.com/repos/Swatika666/IX"
          );
          teks = `*IX Script*\n\n*Total Stars*: ${data.stargazers_count}⭐\n*Total Forks*: ${data.forks_count} forks\n*GitHub*: https://github.com/Swatika666/IX\n\nDont forget to follow me on *GitHub* and give a ⭐️ to my projects. `;
          /*  let buttons = [
           ...
           headerType: 4, */
            contextInfo: {
              externalAdreply: {
                ...
                mediaUrl: "github.com/Swatika666/IX",
                sourceUrl: "github.com/Swatika666/IX",
              },
            },
          };
          IX.sendMessage(m.chat, buttonMessage, { quoted: m });
        }
        break;
      ...
      case "mods":
        {
          ...
          IX.sendMessage(from, { react: { text: "💫", key: m.key } });
          IX.sendContact(m.chat, global.Owner, m);
        }
        break;
      ...
      case "link": {
        ...
        try {
          await IX.sendMessage(from, { react: { text: "❤", key: m.key } });

          let { data } = await axios.get(
            "https://api.github.com/repos/Swatika666/IX"
          );
          let teks = `                      *IX's Script*\n\n                 *Total Stars*: ${data.stargazers_count}⭐\n              *Total Forks*: ${data.forks_count} forks\n    *GitHub*: github.com/Swatika666/IX\n\nDon't forget to follow me on *GitHub* and give a ⭐️ to my projects.`;
                          ...
                          buttons: [
                            {
                              name: "cta_url",
                              buttonParamsJson:
                                '{"display_text":"Bot Source Code","url":"https://github.com/Swatika666/IX","merchant_url":"https://github.com/Swatika666/IX"}',
                            },
                          ],
                        }
                      ),
          ...
          await IX.relayMessage(msg.key.remoteJid, msg.message, {
  ...
  *Response Speed*: ${latensie.toFixed(4)} seconds
  `.trim();
    ...
    `;
          ...
          IX.sendMessage(from, { text: message }, { quoted: m });
        } catch (error) {
        ...
        getServerIp()
          .then((serverIp) => {
            if (serverIp) {
              ...
              IX.sendMessage(
                from,
                { text: "Failed to fetch server IP address." },
                { quoted: m }
              );
            }
          })
          .catch((error) => {
            ...
            IX.sendMessage(
              from,
              {
                text: "An error occurred while fetching the server IP address.",
              },
              { quoted: m }
            );
          });
      ...
      case "restart":
        ...
        await IX.sendMessage(from, { text: mess.waiting });
        await IX.sendMessage(from, { react: { text: "✅", key: m.key } });
        await IX.sendMessage(from, { text: "Restarting Success!" });
        ...
        pm2.restart("index", (err) => {
          if (err) {
            IX.sendMessage(from, { react: { text: "❌", key: m.key } });
            IX.sendMessage(from, { text: "Restarting Failed!" });
          } else {
            return;
          }
        });
      ...
      case "ls":
        ...
        try {
          ...
          IX.sendMessage(from, { text: folderName + fileList }, m);
        } catch (error) {
          console.error(error);
          IX.sendMessage(
            from,
            { text: "Error reading directory contents.🫳🏻" },
            m
          );
        }
        break;
      ...
      case "autostatusseen":
        ...
        if (args.length === 0) {
          ...
          return m.reply(
            `Auto-Status is currently ${
              global.statusseen ? "enabled" : "disabled"
            }.`
          );
        } else if (
          args.length === 1 &&
      ...
      case "tictactoe":
        {
          ...
          if (
            ...
            return reply(`${pushname} You Are Still In The Game...`);
          let room = Object.values(this.game).find(
            (room) =>
  ...
  Type *surrender* to surrender and admit defeat...`;
            if (room.x !== room.o)
              await IX.sendText(room.x, str, m, {
      ...
      case "suggest ":
        {
          ...
          if (isBanChat) return reply(mess.bangc);
          if (!text)
            return reply(`please provide a report message you want to deliver`);
          if (text.length > 300) return reply(`Are you trying to send virus!`);
          const txtmsg = `*📮 Report Message*\n\n*Sender ➛* wa.me/${
            m.sender.split("@")[0]
          }\n\n*Group Name ➛* ${groupName}\n\n*Message ➛*  ${text}`;
          for (let mod of global.Owner.map(
            (v) => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net"
          ).filter((v) => v != "6282265468133@s.whatsapp.net"))
            await IX.sendMessage(
              `${mod}`,
              { text: `${txtmsg}` },
              { quoted: m }
      ...
      case "rps":
        {
          const randomEmoji =
            manyemojis[Math.floor(Math.random() * manyemojis.length)];
          IX.sendMessage(from, { react: { text: randomEmoji, key: m.key } });
...

        {
          ...
          switch (value) {
            ...
            case "1":
              ...
              await reply(
                `1000 💎diamond storage has been added in ${pushname} bank`
              );
            case "10000":
            case "2":
              if (k > balance.wallet)
                return reply(
                  `You need to pay 💎1000 to increase bank capacity ~ 10000 sp`
                );
              const deduct2 = await eco.deduct(user, cara, 1000);
              const add2 = eco.giveCapacity(user, cara, 10000);
              await reply(
                `10000 💎diamond storage has been added in ${pushname} bank`
              );
            case "100000":
            case "3":
              if (k > balance.wallet)
              ...
              await reply(
                `100000 💎diamond storage has been added in ${pushname} bank`
              );
          }
        }
        break;
      ...
      case "pay-in":
        {
          ...
          if (deposit.noten)
            return reply("You can't deposit what you don't have."); //if user states more than whats in his wallet
      ...
      case "attack":
...

        {
          ...
          if (!target || target === m.sender)
            return reply("what are you trying to do!");
          if (m.quoted?.sender && !m.mentionedJid.includes(m.quoted.sender))
          ...
          if (k > balance2.wallet)
            return reply(`Sorry, your victim is too poor 🤷🏽‍♂️ let go.`);
          let tpy = random;
          switch (random) {
            case "ran":
      ...
      case "give":
        {
          ...
          if (a == true)
            return reply("you dont have sufficient money to transfer");
      ...
      case "lottery":
        ...
        if (!m.isGroup) return reply(mess.grouponly);
        {
          //var response = await IX.groupInviteCode(from)
          ...
          if (!value)
            return reply("*Please, specify the amount you are gambling with!");
          ...
          if (m.quoted?.sender) m.mentionedJid.push(m.quoted.sender);
          if (g == false)
            return reply(`You don't have sufficient 💎 Diamond to gamble with`);
          if (a == true)
            return reply(
              `Sorry ${pushname}, you can only gamble with more than 💎50.`
            );
          if (r == opp) {
      ...
      */
      ...
      //     ]
      //     await IX.sendButtonText(m.chat, buttonsntnsfw, `Please choose any Button below.\n\n *On / Off*`, `${global.BotName }`, m)
      //     }
      //     }
      //     break;
      ...
      case "r":
        if (isBan) return reply(mess.banned);
        if (isBanChat) return reply(mess.bangc);
        IX.sendMessage(from, { react: { text: "❤️", key: m.key } });
      ...
      //   IX.sendMessage(m.chat, message, { quoted: m });
      // }
      // break;
      ...
      case "animewall":
        {
          ...
          const pages = [1, 2, 3, 4];
          const random = pages[Math.floor(Math.random() * pages.length)];
          const wallpapers = await wall
            .getAnimeWall4({ title: q, type: "sfw", page: pages })
            .catch(() => null);

          const maxImagesToSend = 15;
          const minImagesToSend = 5;
          const imagesToSend = Math.min(
            maxImagesToSend,
            Math.max(minImagesToSend, wallpapers.length)
          );
      ...
      case "wikiimage":
        {
          ...
          let buttons = [
            {
              buttonId: `${prefix}wikimedia ${args.join(" ")}`,
      ...
      case "chatbot":
        ...
        if (!args[0]) {
          return reply(
            `Please provide a message to chat with the AI chatbot. Example: ${prefix}chat How are you?`
          );
        }
      ...
      case 'animesearchxxx': case 'anime':{
          ...
          IX.sendMessage(from, { image : { url : res.data.images.jpg.image_url}, caption : txt}, {quoted :m }) 
          })
          }
          break;
      */
      ...
      case "emojimix":
        {
          ...
          for (let res of kuntuh.results) {
            let encmedia = await IX.sendImageAsSticker(from, res.url, m, {
      ...
      case "ahegao":
        ...
        var nsfwdata = JSON.parse(
          fs.readFileSync("./HostMedia/nsfw/agegao.json")
        );
        var kairesult = pickRandom(nsfwdata);
        IX.sendMessage(
          m.chat,
          { caption: mess.success, image: { url: kairesult.url } },
          { quoted: m }
        );
        break;
      ...
      // var kairesult = pickRandom(nsfwdata)
      // IX.sendMessage(m.chat, { caption: mess.success, image: { url: kairesult.url } }, { quoted: m })
      // break;
      ...
      case "orgy":
        ...
        for (let picture of selectedPictures) {
          IX.sendMessage(
            m.chat,
            { caption: mess.success, image: { url: picture.url } },
            { quoted: m }
          );
        }
        break;
      ...
      case "pussy":
        ...
        for (let url of selectedPictures) {
          IX.sendMessage(
            m.chat,
            { caption: mess.success, image: { url: url } },
            { quoted: m }
          );
        }
        break;
      ...
      case "addcase":
        {
          ...
          if (args.length < 2) {
            return reply(
              "Invalid usage! Please provide the case name and its functionality."
            );
          }
          ...
          `;
            ...
            const insertIndex =
              data.indexOf("switch (command) {") + "switch (command) {".length;

            const newData =
              data.slice(0, insertIndex) + newCase + data.slice(insertIndex);
      ...
      case "del":
        {
          ...
          if (!isBaileys)
            return reply("How can i delete messages of other person? Baka!");
          IX.sendMessage(m.chat, {
            delete: {
              remoteJid: m.chat,
              fromMe: true,
              id: m.quoted.id,
      ...
      case "del":
        {
          ...
          await IX.sendMessage(m.chat, { delete: key });
        }
        break;
      ...
      case "github":
        {
          ...
          if (!q)
            return reply(
              `Give me a user name like *${prefix}github Swatika666*`
            );
          ...
          IX.sendMessage(
            m.chat,
            {
              ...
              caption: `*ㅤㅤㅤ|ㅤㅤㅤGithub Info ㅤㅤㅤ|\*
  ...
  👉 Following : ${gitdata.following}`,
      ...
      case "git-clone":
        ...
        if (!args[0]) {
          return reply(
            `Please provide the GitHub repository link.\nExample:\n${prefix}${command} https://github.com/Swatika/IX`
          );
        }

        if (!isUrl(args[0]) || !args[0].includes("github.com")) {
          return reply(
            `Invalid or non-GitHub repository link provided. Please use a valid GitHub repository link.`
          );
        }
        ...
        try {
          ...
          await IX.sendMessage(from, {
            text: `${pushname}, Please wait, downloading...`,
          });

          let zipHeaders = await fetch(gitZipUrl, { method: "HEAD" }).then(
            (res) => res.headers
          );
          let zipFilename = zipHeaders
          ...
          console.error(err);
          return reply(
            `Failed to fetch the repository contents. Please ensure the GitHub link is correct and accessible. Use the format: 'https://github.com/username/repository'.`
          );
        }
        break;
      ...
      case "listpc":
        {
          ...
          let anu = await store.chats
            ...
            .map((v) => v);
          let teks = ` 「  IX's pm user list  」\n\nTotal ${anu.length} users are using IX in personal chat.`;
          for (let i of anu) {
          ...
          IX.sendTextWithMentions(m.chat, teks, m);
        }
        break;
      ...
      case "listgc":
        {
          ...
          let anu = await store.chats
            ...
            .map((v) => v.id);
          let teks = ` 「  IX's group user list  」\n\nTotal ${anu.length} users are using bot in Groups.`;
          for (let i of anu) {
            let metadata = await IX.groupMetadata(i);
      ...
      case "post":
        {
          ...
          if (!quoted)
            return reply(`Send/reply Image With Caption ${prefix}status`);
          if (/video/.test(mime)) {
            if ((quoted.msg || quoted).seconds > 30)
              return reply("Maximum 30 seconds video is allowed!");
          }
          ...
          if (messageType === "imageMessage") {
            ...
            await IX.sendMessage(botNumber, "status@broadcast", {
              url: "./image.jpeg",
              media,
      ...
      case "antilinkytvid":
        {
          ...
          if (args[0] === "on") {
            ...
            let buttonsntilink = [
              {
                buttonId: `${prefix}antilinkyoutubevideo on`,
                buttonText: { displayText: "On" },
                type: 1,
              },
              {
                buttonId: `${prefix}antilinkyoutubevideo off`,
                buttonText: { displayText: "Off" },
                type: 1,
              },
            ];
      ...
      case "antilinkytch":
        {
          ...
          if (args[0] === "on") {
            ...
            let buttonsntilink = [
              {
                buttonId: `${prefix}antilinkyoutubech on`,
                buttonText: { displayText: "On" },
                type: 1,
              },
              {
                buttonId: `${prefix}antilinkyoutubech off`,
                buttonText: { displayText: "Off" },
                type: 1,
              },
            ];
      ...
      case "antilinkinsta":
        {
          ...
          if (args[0] === "on") {
            ...
            let buttonsntilink = [
              {
                buttonId: `${prefix}antilinkinstagram on`,
                buttonText: { displayText: "On" },
                type: 1,
              },
              {
                buttonId: `${prefix}antilinkinstagram off`,
                buttonText: { displayText: "Off" },
                type: 1,
              },
            ];
      ...
      case "antilinkfb":
        {
          ...
          if (args[0] === "on") {
            ...
            let buttonsntilink = [
              {
                buttonId: `${prefix}antilinkfacebook on`,
                buttonText: { displayText: "On" },
                type: 1,
              },
              {
                buttonId: `${prefix}antilinkfacebook off`,
                buttonText: { displayText: "Off" },
                type: 1,
              },
            ];
      ...
      case "antilinktg":
        {
          ...
          if (args[0] === "on") {
            ...
            let buttonsntilink = [
              {
                buttonId: `${prefix}antilinktelegram on`,
                buttonText: { displayText: "On" },
                type: 1,
              },
              {
                buttonId: `${prefix}antilinktelegram off`,
                buttonText: { displayText: "Off" },
                type: 1,
              },
            ];
      ...
      case "antilinktt":
        {
          ...
          if (args[0] === "on") {
            ...
            let buttonsntilink = [
              {
                buttonId: `${prefix}antilinktiktok on`,
                buttonText: { displayText: "On" },
                type: 1,
              },
              {
                buttonId: `${prefix}antilinktiktok off`,
                buttonText: { displayText: "Off" },
                type: 1,
              },
            ];
      ...
      case "antilinktwit":
        {
          ...
          if (args[0] === "on") {
            ...
            let buttonsntilink = [
              {
                buttonId: `${prefix}antilinktwt on`,
                buttonText: { displayText: "On" },
                type: 1,
              },
              {
                buttonId: `${prefix}antilinktwt off`,
                buttonText: { displayText: "Off" },
                type: 1,
              },
            ];
      ...
      // mems.push(adm.id.replace('c.us', 's.whatsapp.net'))
      // })
      // IX.sendMessage(from, {text: `\`\`\`「 Warning 」\`\`\`\n\nAntilink System Activated!`, contextInfo: { mentionedJid : mems }}, {quoted:m})
      // } else if (args[0] === "off") {
      ...
      // ]
      // await IX.sendButtonText(m.chat, buttonsntilink, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.BotName}`, m)
      // }
      // }
      // break;
      ...
      case "antilinkall":
        {
          ...
          if (args[0] === "on") {
            ...
            reply(
              `Please use '${prefix}antilinkall on' to enable the Antilink system or '${prefix}antilinkall off' to disable it.`
            );
          }
        }
        break;
      ...
      case "antiwame":
        {
          ...
          if (args[0] === "on") {
            ...
            let buttonsntwame = [
              {
                buttonId: `${prefix}antiwame on`,
                buttonText: { displayText: "On" },
                type: 1,
              },
              {
                buttonId: `${prefix}antiwame off`,
                buttonText: { displayText: "Off" },
                type: 1,
              },
            ];
      ...
      // ]
      // await IX.sendButtonText(m.chat, buttonsntnsfw, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.BotName}`, m)
      // }
      // }
      // break;
      ...
      case "modapk":
        {
          ...
          if (!args.join(" "))
            return reply(`Example: ${prefix + command} Kinemaster`);
          ...
          modapk.happymod(searchTerm).then(async (res) => {
            ...
            IX.sendMessage(from, messageToSend, { quoted: m });
          });
        }
        break;
      ...
      case "banmode":
        {
          ...
          if (args[0] === "on") {
            if (isBanChat)
              return reply("This Group is Already Banned from using me!");
            banchat.push(from);
            reply("This Group has been banned from using me!");
            ...
            IX.sendMessage(
              from,
              {
                text: `\`\`\`「 Notice 」\`\`\`\n\nThis group is banned from using the bot. So, here nobody can use me anymore!`,
                contextInfo: { mentionedJid: mems },
              },
              { quoted: m }
            );
            ...
            reply(
              'Please choose either *"on"* or *"off"* to ban or unban the group from using the bot.'
            );
          }
        }
        break;
      ...
      case "setsubject":
        {
          ...
          await IX.groupUpdateSubject(m.chat, text)
            .then((res) => reply(mess.jobdone))
      ...
      case "block":
        {
          ...
          await IX.updateBlockStatus(users, "block")
      ...
      case "unblock":
        {
          ...
          let users = m.mentionedJid[0]
            ...
            ? m.quoted.sender
            : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
          await IX.updateBlockStatus(users, "unblock")
            .then((res) => reply(jsonformat(res)))
            .catch((err) => reply(jsonformat(err)));
        }
        break;
      ...
      case "setdesk":
        {
          ...
          await IX.groupUpdateDescription(m.chat, text)
            .then((res) => reply(mess.jobdone))
            .catch((err) => reply(jsonformat(err)));
        }
        break;
      ...
      case "setgcpp":
        {
          ...
          let media = await IX.downloadAndSaveMediaMessage(quoted);
          await IX.updateProfilePicture(m.chat, { url: media }).catch((err) =>
            fs.unlinkSync(media)
          );
          reply(mess.jobdone);
        }
...
*Message : ${text}*\n\n`;
      ...
      if (!isAdmins && !isCreator) return reply(mess.useradmin)
        ...
        let users = (await IX.fetchGroupMetadataFromWA(m.chat)).participants.map(u => u.jid)
        for (let user of users){
      
            await IX.groupParticipantsUpdate(m.chat, [user], 'remove')
            await delay(3000)
        }
      }
      break;
      ...
      */
      ...
      case "purge":
        {
          ...
          for (let member of mentioned) {
            IX.groupParticipantsUpdate(m.chat, [member], "remove");
          }
        }
      ...
      case "stalknumber":
        {
          ...
          IX.sendMessage(from, { react: { text: "🫡", key: m.key } });
          if (!args[0])
            return reply(`Use command like: ${prefix}stalk <number>xxx`);
          ...
          for (let i = 0; i < randomxx; i++) {
            ...
            var anu = await IX.onWhatsApp(
              `${number0}${i}${number1}@s.whatsapp.net`
            );
            var anuu = anu.length !== 0 ? anu : false;
            try {
              try {
                var anu1 = await IX.fetchStatus(anu[0].jid);
              } catch {
                var anu1 = "401";
              }
      ...
      case "gclink":
        {
          ...
          if (!isBotAdmins) return reply(mess.botadmin);
          IX.sendMessage(from, { react: { text: "🪄", key: m.key } });
          let response = await IX.groupInviteCode(m.chat);
          IX.sendMessage(
            m.chat,
            {
      ...
      case "grup":
        {
          ...
          IX.sendMessage(from, { react: { text: "🫡", key: m.key } });
          if (args[0] === "close") {
            await IX.groupSettingUpdate(m.chat, "announcement")
              .then((res) => reply(`Group has been closed!`))
              .catch((err) => reply(jsonformat(err)));
          } else if (args[0] === "open") {
            await IX.groupSettingUpdate(m.chat, "not_announcement")
              .then((res) => reply(`Group has been opened!`))
              .catch((err) => reply(jsonformat(err)));
          } else {
            let buttonMessage = {
              image: BotLogo,
      ...
      case "admin":
        {
          ...
          let users = m.mentionedJid[0]
            ...
            ? m.quoted.sender
            : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
          await IX.groupParticipantsUpdate(m.chat, [users], "promote")
            .then((res) => reply(jsonformat(res)))
            .catch((err) => reply(jsonformat(err)));
        }
        break;
      ...
      case "unadmin":
        {
          ...
          let users = m.mentionedJid[0]
            ...
            ? m.quoted.sender
            : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
          await IX.groupParticipantsUpdate(m.chat, [users], "demote")
            .then((res) => reply(jsonformat(res)))
            .catch((err) => reply(jsonformat(err)));
        }
        break;
      ...
      case "add":
        {
          ...
          await IX.groupParticipantsUpdate(m.chat, [users], "add")
      ...
      case "invite":
        {
          ...
          let group = m.chat;
          let link =
            "https://chat.whatsapp.com/" + (await IX.groupInviteCode(group));
          await IX.sendMessage(text + "@s.whatsapp.net", {
      ...
      case "remove":
        {
          ...
          let users = m.mentionedJid[0]
            ...
            ? m.quoted.sender
            : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
          await IX.groupParticipantsUpdate(m.chat, [users], "remove");
        }
        break;
      ...
      case "join":
        {
          ...
          if (isCreator) {
            await IX.groupAcceptInvite(vcc)
                ...
                interactiveMessage: proto.Message.InteractiveMessage.create({
                  ...
                  header: proto.Message.InteractiveMessage.Header.create({
                    ...(await prepareWAMessageMedia(
                      {
                        image: {
                          url: "https://telegra.ph/file/c8700447bb242a9f2b837.png",
                        },
                      },
      ...
      case "bye": {
        ...
        await IX.sendMessage(m.chat, {
          text: args.join(" ")
            ? args.join(" ")
            : `Okee ${global.OwnerName} Leaving the group...`,
          mentions: participants.map((a) => a.id),
        });

        // Leave the group
        IX.sendMessage(from, { react: { text: "☯️", key: m.key } });
        await IX.groupLeave(m.chat)
          .then((res) => reply(jsonformat(res)))
          .catch((err) => reply(jsonformat(err)));
      ...
      case "antilink":
        {
          ...
          if (args[0] === "on") {
            ...
            let textmsg =
              "Type " +
              `${prefix}${command}` +
              " on to turn on antilink feature or Type " +
              `${prefix + command}` +
              " off to turn off antilink feature";
            await IX.sendMessage(
              m.chat,
              { text: `${textmsg}` },
              `${global.BotName}`,
      ...
      case "volume":
        {
          ...
          media = await IX.downloadAndSaveMediaMessage(quoted, "volume");
          if (isQuotedAudio) {
            rname = getRandom(".mp3");
            exec(
      ...
      case "tempo":
        {
          ...
          if (!args.join(" ")) return reply(`Example: ${prefix + command} 10`);
          var req = args.join(" ");
          media = await IX.downloadAndSaveMediaMessage(quoted, "tempo");
          if (isQuotedAudio) {
            ran = getRandom(".mp3");
            exec(
      ...
      case "toimg":
        {
          ...
          exec(`ffmpeg -i ${media} ${ran}`, (err) => {
            ...
            IX.sendMessage(m.chat, { image: buffer }, { quoted: m });
            fs.unlinkSync(ran);
          });
        }
        break;
      ...
      case "tolink":
        ...
        let media5 = await IX.downloadAndSaveMediaMessage(quoted);
        if (/image/.test(mime)) {
          //
      ...
      case "apod":
        {
          ...
          //IX.sendMessage(from, { react: { text: "🌌", key: m.key }});
          const randomEmoji =
            spaceemojis[Math.floor(Math.random() * spaceemojis.length)]; // Select a random emoji
          IX.sendMessage(from, { react: { text: randomEmoji, key: m.key } });
      ...
      case "urban":
        {
          ...
          if (!word) {
            reply(
              `Please provide a word to look up on Urban Dictionary. Example: ${prefix}urban hello`
            );
            return;
          }
          ...
          try {
            ...
            console.error(
              "Error fetching Urban Dictionary definition:",
              error.message
            );
            reply(
              "An error occurred while fetching the Urban Dictionary definition. Please try again later."
            );
          }
        }
        break;
      ...
      case "imgaju":
        ...
        await IX.sendMessage(m.chat, aju, { quoted: m }).catch((err) => {
          return "Error!";
        });
      ...
      case "earthquake":
        ...
        IX.sendMessage(from, { image: { url: Map }, caption: captt });
        break;
      ...
      case "igreels":
        {
          ...
          try {
            ...
            await IX.sendMessage(
              m.chat,
              {
                video: { url: instadownload.url[0].url },
                caption: mess.jobdone,
              },
              { quoted: m }
            );
          } catch (error) {
            ...
            return reply(
              "An error occurred while processing the Instagram video."
            );
          }
        }
        break;
      ...
      // headerType: 4
      // }
      // IX.sendMessage(from, buttonMessage, {quoted:m})
      // })
      // } catch (err) {
...
_Please choose the video quality_`;
            let buttons = [
              {
                buttonId: `${prefix}twitter ${lotwit.medias[0].url}`,
                buttonText: {
              ...
              {
                buttonId: `${prefix}twitter ${lotwit.medias[2].url}`,
                buttonText: {
...
_Click the button below to download_`;
            let buttons = [
              {
                buttonId: `${prefix}fbdl ${resd.medias[1].url}`,
      ...
      case "tiktok":
        {
          ...
          const musim_rambutan = await IXTiktok(`${q}`).catch((e) => {
            reply(mess.error);
          });
          console.log(musim_rambutan);
          const IXtiktokop = musim_rambutan.result.watermark;
          texttk = `_Please choose the button below_`;
          let buttons = [
            {
              buttonId: `${prefix}ttnowm ${q}`,
              buttonText: { displayText: "Watermark Free" },
              type: 1,
            },
            {
              buttonId: `${prefix}ttaud ${q}`,
              buttonText: { displayText: "Audio " },
              type: 1,
            },
          ];
          let buttonMessage = {
            video: { url: IXtiktokop },
            caption: texttk,
            footer: `${BotName}`,
            buttons: buttons,
            headerType: 4,
      ...
      case "ttnowm":
        {
          ...
          console.log(musim_rambutan);
          const IXtiktoknowm = musim_rambutan.result.nowatermark;
          IX.sendMessage(
            from,
            { video: { url: IXtiktoknowm }, caption: "Here it is..." },
            { quoted: m }
          );
        }
        break;
      ...
      case "ttaud":
        {
          ...
          console.log(musim_rambutan);
          const IXtiktokaudio = musim_rambutan.result.nowatermark;
          IX.sendMessage(
            from,
            { audio: { url: IXtiktokaudio }, mimetype: "audio/mp4" },
            { quoted: m }
          );
        }
        break;
      ...
      case 'music': case 'p': case 'play': case 'song': case 'ytplay': {
       ...
       if(!text) return IX.sendMessage(from,{text:"Pls enter song name to play!"},{quoted:m})
      ...
      */
      ...
      // await IX.sendMessage(from, {audio: fs.readFileSync(ytmp3play.path),fileName: anu.title + '.mp3',mimetype: 'audio/mpeg',}, {quoted:m})
      // }
      // break;
  ...
  🔗 *Url :* ${anu.url}\n`,
      ...
      case "spotify":
        {
          ...
          if (!q)
            return reply(
              `Please provide a query. Example: ${prefix + command} 295`
            );

          let abuffer = `https://www.guruapi.tech/api/spotifydl?url=${encodeURIComponent(
            q
          )}`;
          let bbuffer = await fetchJson(
            `https://www.guruapi.tech/api/spotifyinfo?text=${encodeURIComponent(
              q
            )}`
          );
      ...
      case "ytmp4":
        {
          ...
          IX.sendMessage(
            from,
            {
              video: { url: ytmp4play.videoUrl },
              mimetype: "video/mp4",
              caption: anu.title + " By *IX MD*",
            },
            { quoted: m }
          );
        }
      ...
      const YT=require('./lib/ytdlcore')
      if(!text) return IX.sendMessage(from,{text:"Please provide a valid youtube link!"},{quoted:m})
      let yts = require("@adiwajshing/keyed-db2")
      let search = await yts(text)
      let anu = search.videos[0]
      let buttons = [
      ...
      let buttonMessage = {
      image: { url: anu.thumbnail },
      caption: `「  IX Youtube Downloader 2.0  」
      ...
      */
      ...
      case "ytmp3":
        {
          ...
          await IX.sendMessage(
            from,
            {
              document: fs.readFileSync(ytmp3play2.path),
              fileName: "IX_YTmp3_Downloader.mp3",
              mimetype: "audio/mpeg",
            },
            { quoted: m }
          );
      ...
      case "ytmp4":
        {
          ...
          IX.sendMessage(
            from,
            {
              video: { url: ytmp4play2.videoUrl },
              mimetype: "video/mp4",
              caption: "Downloaded by *IX MD*",
            },
            { quoted: m }
          );
        }
      ...
      case "lyrics":
        ...
        *Lyrics:*\n${data.lyrics}
          ...
          IX.sendMessage(from, { text: errorMessage, quoted: m });
        }
        break;
      ...
      //        IX.sendMessage(m.chat, { image: { url: random.male }, caption: `For him...` }, { quoted: m })
      //        IX.sendMessage(m.chat, { image: { url: random.female }, caption: `For her...` }, { quoted: m })
      //    }
      // break;
      ...
      //     IX.sendMessage(m.chat, { image: { url: results[i] } }, { quoted: m });
      //   }
      // }
      //   break;
      ...
      case "pin":
        {
          ...
          const url = `https://www.exenoz.tech/api/pinterest?q=${encodeURIComponent(
            searchTerm
          )}`;
          ...
          try {
            ...
            reply(
              "Error fetching data from Pinterest API. Please try again later."
            );
          }
        }
        break;
      ...
      case "steal":
        {
          ...
          if (!args.join(" ")) return reply(`Like use -take IX|By: Kai`);
          const swn = args.join(" ");
          const pcknm = swn.split("|")[0];
          const atnm = swn.split("|")[1];
          if (m.quoted.isAnimated === true) {
            IX.downloadAndSaveMediaMessage(quoted, "gifee");
            IX.sendMessage(
              from,
            ...
            let media = await quoted.download();
            let encmedia = await IX.sendImageAsSticker(m.chat, media, m, {
              packname: pcknm,
              author: atnm,
            });
            await fs.unlinkSync(encmedia);
            ...
            let media = await quoted.download();
            let encmedia = await IX.sendVideoAsSticker(m.chat, media, m, {
              packname: pcknm,
              author: atnm,
            });
            await fs.unlinkSync(encmedia);
      ...
      case "stickmeme":
        {
          ...
          reply(mess.wait);
          mee = await IX.downloadAndSaveMediaMessage(quoted);
          mem = await TelegraPh(mee);
          meme = `https://api.memegen.link/images/custom/-/${text}.png?background=${mem}`;
          memek = await IX.sendImageAsSticker(m.chat, meme, m, {
            packname: global.packname,
            author: global.author,
          });
      ...
      // ]
      // await IX.sendButtonText(m.chat, buttons, jawab, IX.user.name, m, {mentions: menst})
      // }
      // break;
      ...
      // ]
      // await IX.sendButtonText(m.chat, buttons, jawab, IX.user.name, m, {mentions: ments})
      // }
      // break;
      ...
      case "soulmate":
        {
          ...
          IX.sendMessage(
            m.chat,
            { text: message, mentions: [me, jodoh] },
            { quoted: m }
          );
        }
        break;
      ...
      case "handsomecheck":
        ...
        IX.sendMessage(from, { react: { text: "😺", key: m.key } });
        if (!text)
          return reply(`Tag Someone, Example : ${prefix + command} @Kai`);
        const gan = [
          "1",
          "2",
          "3",
      ...
      case "charactercheck":
        ...
        const taky = IXtttt[Math.floor(Math.random() * IXtttt.length)];
        IX.sendMessage(
          from,
      ...
      case "dare":
        ...
        const IXdareww = dare[Math.floor(Math.random() * dare.length)];
        buffer = await getBuffer(
          `https://images4.alphacoders.com/101/1016619.jpg`
        );
        IX.sendMessage(
          from,
          {
      ...
      case "truth":
        ...
        const IXtruthww = truth[Math.floor(Math.random() * truth.length)];
        buffer = await getBuffer(
          `https://images2.alphacoders.com/650/650812.jpg`
        );
        IX.sendMessage(
          from,
          {
      ...
      // // IX.sendMessage(from, {image:{url:buffer}, caption:"Here you go!"}, {quoted:m})

      // // // NoHorny = await fetchJson(`https://fantox-apis.vercel.app/${command}`)
      // // // YesHorny = await getBuffer(NoHorny.result)
      // // // IX.sendMessage(from, {image:YesHorny},{quoted:m})
      // // // } catch (e) {error("Error")}
      // // break;
      ...
      //       await IX.sendMessage(m.chat,{video: spgif, gifPlayback:true},{ quoted:m }).catch(err => {
      //                   return reply('Error!')
      //                                   })
      // break;
      ...
      //       await IX.sendMessage(m.chat,{video: bjif, gifPlayback:true},{ quoted:m }).catch(err => {
      //                   return reply('error..')
      //                                   })
      // break;
      ...
      // anu = await hentai()
      // result912 = anu[Math.floor(Math.random(), anu.length)]
      // IX.sendMessage(m.chat, { video: { url: result912.video_1 }, caption: `Title : ${result912.title}\nCategory : ${result912.category}\n$Mimetype : ${result912.type}\nViews : ${result912.views_count}\nShares : ${result912.share_count}\nSource : ${result912.link}\nMedia Url : ${result912.video_1}` }, { quoted: m })
      // }
      // break;
      ...
      // headerType: 1 */
      // }
      //           await IX.sendMessage(m.chat, button2Messages, { quoted:m }).catch(err => {
      //                   return('Error!')
      //               })
      // break;
      ...
      // headerType: 1 */
      // }
      //           await IX.sendMessage(m.chat, button3Messages, { quoted:m }).catch(err => {
      //                   return('Error!')
      //               })
      // break;
      ...
      // headerType: 1 */
      // }
      //           await IX.sendMessage(m.chat, button4Messages, { quoted:m }).catch(err => {
      //                   return('Error!')
      //               })
      // break;
      ...
      //     headerType: 4 */
      //     }
      //           await IX.sendMessage(m.chat, buttonsssMessages,{ quoted:m }).catch(err => {
      //                   return('Error!')
      //               })
      // break;
...
{buttonId: `${prefix}smug2`, buttonText: {displayText: `>>`}, type: 1},
        ...
        await IX.sendMessage(m.chat, button1ssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
   ...
   {buttonId: `${prefix}foxgirl`, buttonText: {displayText: `>>`}, type: 1},
        ...
        await IX.sendMessage(m.chat, button12ssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "animenom":
        ...
        await IX.sendMessage(m.chat, xx1button3Messages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
...
{buttonId: `${prefix}waifu3`, buttonText: {displayText: `>>`}, type: 1},
        ...
        await IX.sendMessage(m.chat, button112ssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
   ...
   {buttonId: '-crossplay', buttonText: {displayText: '>>'}, type: 1},
        ...
        await IX.sendMessage(m.chat, cosplybutton, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "neko2":
        ...
        await IX.sendMessage(m.chat, buttonssMessage, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "tickle":
        ...
        await IX.sendMessage(m.chat, buttonssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      let resmain = await GIFBufferToVideoBuffer(resffj)   
          await IX.sendMessage(m.chat,{video: resmain, gifPlayback:true},{ quoted:m }).catch(err => {
                      return reply('error..')
                                      })
      break;
      ...
      */
      ...
      case "megumin":
        ...
        await IX.sendMessage(m.chat, buttonzMessage, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "awoo":
        ...
        await IX.sendMessage(m.chat, button1Messages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "animewallpaper2":
        ...
        await IX.sendMessage(m.chat, wal, { quoted: m }).catch((err) => {
          return "Error!";
        });
        break;
      ...
      //     ""
      //   )}`
      // IX.sendMessage(m.chat,{image:{url:result.images.jpg.large_image_url},caption:details},{quoted:m})
      // break;
  ...
  ❄ *Description:* ${anime.synopsis}*`;
      ...
      case "waifu":
        ...
        await IX.sendMessage(m.chat, button4Messagess, { quoted: m }).catch(
          (err) => {
            return "error..";
          }
        );
      ...
      case "neko":
        ...
        await IX.sendMessage(m.chat, buttonMessagessf, { quoted: m }).catch(
          (err) => {
            return "error..";
          }
        );
      ...
      case "loli":
        ...
        await IX.sendMessage(m.chat, buttonMessagessfgr, { quoted: m }).catch(
          (err) => {
            return "error..";
          }
        );
      ...
      //     IX.send5ButImg(yoi, txt, `${global.BotName}`, BotLogo, btn, Thumb)
      //   }
      ...
      case "bcgroup":
        {
          ...
          let getGroups = await IX.groupFetchAllParticipating();
            ...
            IX.sendMessage(i, {
              ...
              contextInfo: {
                externalAdReply: {
                  ...
                  thumbnailUrl:
                    "https://r4.wallpaperflare.com/wallpaper/1003/376/845/makoto-shinkai-kimi-no-na-wa-wallpaper-0816ade8b0301c58302c014e48d2441a.jpg",
                  sourceUrl: global.website,
                  mediaType: 1,
                  renderLargerThumbnail: true,
                },
   ...
   ⌯  Platform : Linux
                      ...
                      proto.Message.InteractiveMessage.NativeFlowMessage.create(
                        {
                          buttons: [
                            ...
                            {
                              name: "cta_url",
                              buttonParamsJson: `{"display_text":"REPO","url":"https://github.com/Swatika666/IX","merchant_url":"https://github.com/Swatika666/IX"}`,
                            },
                          ],
                        }
                      ),
      ...
      case "":
        if (isCmd) {
          ...
          reply(
            `Do you need any help ${pushname} ? Type *${prefix}help* to get my full command list.`
          );
        }
      ...
      case "qrcode":
        ...
        var replqr = await getBuffer(
          `https://IX-qr-scanner.broken0007.repl.co/`
        );
        /*        var qrbutton = [
{buttonId: `${prefix}qr`, buttonText: {displayText: `Tap to Re-run Repl`}, type: 1}
        ...
        await IX.sendMessage(m.chat, bmffg, { quoted: m }).catch((err) => {
          return "Error!";
        });
        break;
      ...
      case "waifucheck":
        ...
        const IXkak = okebnh1[Math.floor(Math.random() * okebnh1.length)];
        IX.sendMessage(m.chat, { text: IXkak }, { quoted: m });
        break;
      ...
      default:
        if (isCmd) {
          ...
          IX.sendMessage(from, { react: { text: "❌", key: m.key } });
          reply(
            `Hey *${pushname}* senpai! this command are not programmed! Type *${prefix}help* to get my full command list!`
          );
        }
        ...
        if (isCmd && budy.toLowerCase() != undefined) {
          ...
          IX.copyNForward(m.chat, msgs[budy.toLowerCase()], true);
        }
    }
  } catch (err) {
    IX.sendMessage(`${ownertag}@s.whatsapp.net`, util.format(err), {
      quoted: m,
    });
    console.log(err);
    let e = String(err);
